    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="adminshop" class="list-group-item active">Food & Toys</a>
        </div>
      </div>
      <!-- Content Column -->
      ...
      <tr>
        ...
        <td align="center" style="vertical-align: middle;">Rp<?=$d['harga'] ?></td>
         <td style="vertical-align: middle;">
          <a href="editadminpetshop?no=<?=$d['no'] ?>" class="btn btn-success btn-sm">Edit</a></td>
        <td style="vertical-align: middle;">
          <a href="adminshop?no=<?=$d['no'] ?>" class="btn btn-danger btn-sm" onclick="return confirm ('Apakah Yakin Menghapus Data');">Hapus</a></td>
      </tr>
