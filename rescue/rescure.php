    ...
    <div class="row">
      ...
      <div class="col-lg-3 mb-4">
        <div class="list-group">
          ...
          <a href="adminrescure.php" class="list-group-item active">Rescure</a> -->
      ...
      <tr>
        ...
        <td align="center" style="vertical-align: middle;"><?=$d['umur_peliharaan'] ?></td>
         <!-- <td style="vertical-align: middle;">
          <a href="editadminrescure.php?no=<?=$d['no'] ?>" class="btn btn-success btn-sm">Edit</a></td>
        <td style="vertical-align: middle;">
          <a href="adminrescure.php?no=<?=$d['no'] ?>" class="btn btn-danger btn-sm" onclick="return confirm ('Apakah Yakin Menghapus Data');">Hapus</a></td>
      </tr> -->
