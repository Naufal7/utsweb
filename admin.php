          ...
          <section class="content">
           ...
           <div class="box box-info">
             ...
             <div style="padding: 20px;"> 
              <a href="inputuser.php" class="btn btn-primary" style="margin-bottom: 10px">+Tambah Data</a>
                  ...
                  foreach ($db->ambil_data()as $d):?> 
                    <tr>
                      ...
                      <td style="vertical-align: middle;">
                        ...
                        <td style="vertical-align: middle;">
                          <a href="delete?id_user=<?=$d['id_user'] ?>" class="btn btn-danger btn-sm" onclick="return confirm ('Apakah Yakin Menghapus Data');">Hapus</a></td>
                        </tr>
