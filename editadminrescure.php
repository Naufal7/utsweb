...
<body>
 ...
 <div class="box-header with-border">
  ...
  <form method="POST" action="updaterescure">
   ...
   <?php
   foreach ($db->getadminrescure($_GET['no'])as $d):?>
    ...
    <input type="text" name="jns_peliharaan" class="form-control" placeholder="Masukan Kota" value="<?=$d['jns_peliharaan']?>">
    <label>Password</label>
    <input type="text" name="umur_peliharaan" class="form-control" placeholder="Masukan Kota" value="<?=$d['umur_peliharaan']?>">
    <label>Password</label>
    </br>
    <button type="submit"  class="btn btn-primary" >
      SIMPAN  
      </button>
      <a href="editadminrescure" class="btn btn-success">CANCEL
      </a>
  </form>
  <?php endforeach ; ?>
</div>
